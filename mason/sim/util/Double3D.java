...
public final class Double3D implements java.io.Serializable
    ...
    /** Returns the x-y projection of this Double3D. 
     * @author Xueyi Zou
     * */
    public final Double2D xy()
    {
    	return new Double2D(x, y);
    }
    
    /** Returns the x-z projection of this Double3D. 
     * @author Xueyi Zou
     * */
    public final Double2D xz()
    {
    	return new Double2D(x, z);
    }
    
    /** Returns the y-z projection of this Double3D. 
     * @author Xueyi Zou
     * */
    public final Double2D yz()
    {
    	return new Double2D(y, z);
    }
}
